 ...
 * both light and dark.
 *
 * Fully rounded pill. Inset inside the active-item pill (radius 9px, 8px x / 4px
 * y padding — see `#nd-sidebar a.p-2` in globals.css): `self-stretch` + `my-[3px]`
 * = the 4px vertical padding plus 3px; `-me-0.5` pulls it 2px into the 8px right
 * padding for a 6px right gap.
 */
