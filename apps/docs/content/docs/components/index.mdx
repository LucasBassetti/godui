...
<Cards>
  ...
  <Card href="/docs/components/collaboration/reactions" title="Reactions">
    Emoji reaction pills with a spring count, a particle burst, and a
    stagger-in picker.
  </Card>
...
<Cards>
  <Card href="/docs/components/buttons/copy-button" title="Copy Button">
    A premium clipboard button with a drawn checkmark, label morph, and
    auto-revert.
  </Card>
  ...
  <Card href="/docs/components/buttons/voice-button" title="Voice Button">
    A push-to-talk mic button with a live, audio-reactive waveform and a pulsing
    recording ring.
  </Card>
  <Card href="/docs/components/buttons/optimistic-toggle-button" title="Optimistic Toggle Button">
    A Follow / Following toggle that flips instantly, rolls back on failure, and
    swaps to a destructive label on hover.
  </Card>
  <Card href="/docs/components/buttons/undo-button" title="Undo Button">
    A Gmail-style deferred-commit affordance with a shrinking countdown ring
    that auto-commits unless undone.
  </Card>
...
<Cards>
  <Card href="/docs/components/backgrounds/neural-grid" title="Neural Grid">
    A neural lattice with signal pulses traveling the edges — the AI-product hero
    background.
  </Card>
