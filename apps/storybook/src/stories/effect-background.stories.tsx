import { EffectBackground, effectBackgroundVariants } from "@godui/components";
...
const meta = {
  ...
  argTypes: {
    variant: {
      control: "select",
      options: effectBackgroundVariants,
    },
  },
  args: { variant: effectBackgroundVariants[0] },
} satisfies Meta<typeof EffectBackground>;
  ...
  render: () => (
    <div className="grid grid-cols-2 gap-4 p-4 sm:grid-cols-3">
      {effectBackgroundVariants.map((variant) => (
        ...
        >
          <EffectBackground variant={variant} />
